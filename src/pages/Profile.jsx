...
const Profile = () => {
    ...
    const copyReferralLink = () => {
        const link = `${window.location.origin}/ref/${user?.walletAddress || localStorage.getItem('walletAddress') || 'CONNECT_WALLET_FIRST'}`;
                ...
                <div className="profile-details-column">
                    ...
                    >
                        ...
                        <div className="personal-info-grid-prime">
                            ...
                            <div className="info-box-prime">
                                <div className="info-label"><Award size={16} /><span>Account ID / Wallet</span></div>
                                <p className="info-value" style={{ fontSize: (user?.walletAddress || localStorage.getItem('walletAddress')) ? '0.75rem' : 'inherit' }}>{user?.walletAddress || localStorage.getItem('walletAddress') || '---'}</p>
                            </div>
                            <div className="info-box-prime">
                    ...
                    >
                        ...
                        <div className="ref-link-copy-box">
                            <div className="link-text">{`${window.location.origin}/ref/${user?.walletAddress || localStorage.getItem('walletAddress') || 'CONNECT_WALLET_FIRST'}`}</div>

...
const Support = () => {
    ...
    const [contactInfo, setContactInfo] = useState({
        email: 'support@dhanik.io',
        liveChat: '#',
        website: 'https://dhanik.io'
    });
    ...
    const contactMethods = [
        ...
        { name: 'Live Chat', detail: contactInfo.liveChat === '#' ? 'Available 24/7' : 'Start Chat', icon: <MessageSquare />, color: '#00E5FF', link: contactInfo.liveChat },
                ...
                <div className="support-right">
                    ...
                    >
                        {contactMethods.map((method, idx) => (
                            <a key={idx} href={method.link} target="_blank" rel="noopener noreferrer" className="method-card" style={{ textDecoration: 'none' }}>
